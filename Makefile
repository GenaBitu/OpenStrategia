...
OBJ_RELEASE = $(OBJDIR_RELEASE)/Camera.o $(OBJDIR_RELEASE)/GUI/Text/Character.o $(OBJDIR_RELEASE)/GUI/Checkbox.o $(OBJDIR_RELEASE)/Font.o $(OBJDIR_RELEASE)/GUI/Image.o $(OBJDIR_RELEASE)/GUI/Text/LineBreak.o $(OBJDIR_RELEASE)/Main.o $(OBJDIR_RELEASE)/Program.o $(OBJDIR_RELEASE)/Renderable.o $(OBJDIR_RELEASE)/RenderableComposite.o $(OBJDIR_RELEASE)/RenderObject.o $(OBJDIR_RELEASE)/RenderObject2D.o $(OBJDIR_RELEASE)/RenderObject3D.o $(OBJDIR_RELEASE)/Program/Shader.o $(OBJDIR_RELEASE)/GUI/Slider.o $(OBJDIR_RELEASE)/GUI/Text.o $(OBJDIR_RELEASE)/Texture.o $(OBJDIR_RELEASE)/Texture/TextureBMP.o $(OBJDIR_RELEASE)/Texture/TextureBridge.o $(OBJDIR_RELEASE)/Texture/TextureDDS.o

OBJ_PROFILE = $(OBJDIR_PROFILE)/Camera.o $(OBJDIR_PROFILE)/GUI/Text/Character.o $(OBJDIR_PROFILE)/GUI/Checkbox.o $(OBJDIR_PROFILE)/Font.o $(OBJDIR_PROFILE)/GUI/Image.o $(OBJDIR_PROFILE)/GUI/Text/LineBreak.o $(OBJDIR_PROFILE)/Main.o $(OBJDIR_PROFILE)/Program.o $(OBJDIR_PROFILE)/Renderable.o $(OBJDIR_PROFILE)/RenderableComposite.o $(OBJDIR_PROFILE)/RenderObject.o $(OBJDIR_PROFILE)/RenderObject2D.o $(OBJDIR_PROFILE)/RenderObject3D.o $(OBJDIR_PROFILE)/Program/Shader.o $(OBJDIR_PROFILE)/GUI/Slider.o $(OBJDIR_PROFILE)/GUI/Text.o $(OBJDIR_PROFILE)/Texture.o $(OBJDIR_PROFILE)/Texture/TextureBMP.o $(OBJDIR_PROFILE)/Texture/TextureBridge.o $(OBJDIR_PROFILE)/Texture/TextureDDS.o
